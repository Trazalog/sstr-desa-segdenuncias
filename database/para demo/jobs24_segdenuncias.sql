...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2018 a las 22:15:21
...
(1, '2018-05-29', 'riesgo aa', 'programa aa', '2018-05-31', 'inclusión aa', 'nro obra aa', 'nro acta aa', 'motivo aa', 12, 'AC'),
(3, '2018-10-02', 'riesgo cc', NULL, '2018-10-03', NULL, 'nro', 'nro acta cc', 'motivo ccc', 12, 'AC');
...
CREATE TABLE `tbl_inspecciones` (
  ...
  `adjunto` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
ALTER TABLE `sisgroupsactions`
  MODIFY `grpactId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=220;
--
...
--
ALTER TABLE `sismenuactions`
  MODIFY `menuAccId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
...
--
ALTER TABLE `tbl_denuncias`
  MODIFY `denunciaid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
