...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2018 a las 17:41:48
...
(7, 13, 'Empleadores', 'fa fa-fw fa-user', 'Empleador', 4),
(8, 13, 'ABM Actividades', 'fa fa-fw fa-list', 'Actividad', 5),
(9, 13, 'ABM Liquidaciones', 'fa fa-fw fa-calculator', 'Liquidacion', 6),
(10, 11, 'ABM Inspectores', 'fa fa-male', 'inspector', 7),
(11, NULL, 'Inspecciones', 'fa fa-clipboard', '', 8),
(12, NULL, 'Denuncias', 'fa fa-upload', '', 9),
(13, NULL, 'Registro Empleladores', 'fa fa-user-circle', '', 3),
(14, 11, 'Altas inspecciones', 'fa fa-clipboard', 'inspeccion', 0),
(15, 12, 'Carga Masiva', 'fa fa-upload', 'import', 0),
(16, 13, 'Panel Empleadores', 'fa fa-fw fa-tasks', 'panelEmpleador', 1),
...
(1, '2018-04-09 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '| Esto lo cambie (ANEXO I  RES. S.R.T. Nº 463/09). |  | No presentó el Relevamiento de Agentes de Riesgo con la nómina de trabajadores expuestos. |', 14, 'AC', 'SRT', NULL),
(2, '2018-04-18 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '| DECLARACION DEL RELEVAMIENTO GENERAL DE RIESGOS LABORALES (ANEXO I  RES. S.R.T. Nº 463/09). |  | No presentó el Relevamiento de Agentes de Riesgo con la nómina de trabajadores expuestos. |', 12, 'AC', 'SRT', NULL);
...
(43, '2018-04-18 00:00:00', 'NO', NULL, '2018-04-18', NULL, '0', NULL, '| DECLARACION DEL RELEVAMIENTO GENERAL DE RIESGOS LABORALES (ANEXO I  RES. S.R.T. Nº 463/09). |  | No presentó el Relevamiento de Agentes de Riesgo con la nómina de trabajadores expuestos. |', 12, 'AC', 2, '30520763127'),
(44, '2018-04-09 00:00:00', 'NO', NULL, '2018-04-09', NULL, '0', NULL, '| Esto lo cambie (ANEXO I  RES. S.R.T. Nº 463/09). |  | No presentó el Relevamiento de Agentes de Riesgo con la nómina de trabajadores expuestos. |', 1, 'AC', 2, '20055435988');
...
(1, '2018-10-29 11:39:43', '2018-10-29 11:39:43', 3, 'inspeccion test', 12, 'C', 35, NULL, NULL, NULL, NULL);
...
(4, 'Jhon Doe', 'inspetor3@gmai.com', '2644555555', 'sector3', 'AC');
...
--
ALTER TABLE `tbl_denuncias`
  MODIFY `denunciaid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `tbl_denuncias_temp`
--
ALTER TABLE `tbl_denuncias_temp`
  MODIFY `denunciaid_temp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `trg_inspecciondenuncia`
  MODIFY `insden_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
