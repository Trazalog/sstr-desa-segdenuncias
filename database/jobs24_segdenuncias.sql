...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2018 a las 13:45:17
...
(1, NULL, 'Clientes', 'fa fa-file-picture-o', 'empresa', 1),
...
(1, 'Comercial', 'venta de cosas'),
(2, 'Industrial', 'fabrico cosas'),
(3, 'Ganadero', 'cria animalitos');
...
CREATE TABLE `tbl_empleadores` (
  ...
  `empleatipo` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_empleadores` (`empleaid`, `empleacui`, `empleafecha`, `empleainscrip`, `empleaexp`, `empleadomicilior`, `empleadepid`, `emplealocid`, `empleadomiciliolegal`, `empleasliquiid`, `empleapmasc`, `empleapfem`, `ampleafechaalta`, `empleatipo`) VALUES
(1, '202133339', '2018-04-20 11:00:30', '51616516', 'mm4566', 'casa', 1, 5, 'domicilio llegal', NULL, '2', '3', '2018-03-26', NULL);
...
--
ALTER TABLE `empresas`
  MODIFY `id_empresa` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `sisgroups`
  MODIFY `grpId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `sisgroupsactions`
--
ALTER TABLE `sisgroupsactions`
  MODIFY `grpactId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
--
...
--
ALTER TABLE `sismenuactions`
  MODIFY `menuAccId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `tbl_actividad`
  MODIFY `actividadid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `tbl_empleadores`
--
ALTER TABLE `tbl_empleadores`
  MODIFY `empleaid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_sisliqui`
  MODIFY `sisliquiid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
