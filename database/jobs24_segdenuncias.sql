...
--
-- Servidor: localhost
-- Tiempo de generación: 07-05-2018 a las 02:50:43
...
INSERT INTO `tbl_empleadores` (`empleaid`, `empleatipo`, `empleacui`, `empleafecha`, `empleainscrip`, `emplearazsoc`, `empleaexp`, `empleadomicilior`, `empleadepid`, `emplealocid`, `empleadomiciliolegal`, `empleasliquiid`, `empleapmasc`, `empleapfem`, `ampleafechaalta`, `empleaprovid`, `empleaestado`) VALUES
(1, '', '202133339', '2018-04-20 11:00:30', '51616516', NULL, 'mm4566', 'casa', 1, 5, 'domicilio llegal', NULL, 2, 3, '2018-03-26', NULL, ''),
(2, 'L', '11-11111111-1', '2018-04-26 00:00:00', 'sdfasdfasdf', 'sdfasdf', 'asdfsadfsd', 'asdfasd', 147, NULL, 'asdfasd', 1, 11, 22, '2018-04-26', 2, ''),
(3, 'L', '11-11111111-1', '2018-04-26 00:00:00', 'sdfasdfasdf', 'sdfasdf', 'asdfsadfsd', 'asdfasd', 147, NULL, 'asdfasd', 1, 11, 22, '2018-04-26', 2, ''),
(4, 'L', '11-11111111-1', '2018-04-26 00:00:00', '1223', 'aagfgagfdgafds', '123123', 'adsfasdfads', 1450, NULL, 'asdfhgthertukljkg', 2, 11, 22, '2018-04-26', 14, 'AN'),
(5, 'C', '12-33345465-7', '2018-04-26 00:00:00', '123', 'qwerwer', 'exp123', 'wqerqwer', 1734, NULL, 'qwerqwer', 2, 0, 0, '2018-04-26', 19, 'AC'),
(6, 'L', '04-45677832-2', '2018-04-27 00:00:00', 'M-1234', 'Industrias TPM S.A.', '2645778', 'libertador 1559 este', 1769, NULL, 'libertador 15559 este ', 2, 3, 0, '2018-04-27', 20, 'AC'),
(7, 'C', '03-75857999-9', '2018-04-27 00:00:00', 'J-444', 'Industrias Selso S.A.', '73456', 'calle barrio', 2, NULL, 'calle barrio 2', 2, 2, 0, '2018-04-27', 1, 'AC'),
(8, 'C', '21-34234234-2', '2018-04-25 00:00:00', '4321', 'qwerwer', '4321', 'qwerqwer', 495, NULL, 'qwerqwer', 2, 0, 0, '2018-04-25', 7, 'AN'),
(9, 'L', '64-76575764-5', '2018-04-27 00:00:00', 'sdfgdg', 'gfdhdhdfh', 'sdfgdfg', 'dfghdfhdfghdfgh', -1, NULL, 'fdghdfghdfh', 3, 0, 0, '2018-04-27', 4, 'AC'),
(10, 'L', '76-89679867-8', '2018-04-27 00:00:00', '8976', 'hgjkghkjghjk', 'hgjfgj', 'ghjkghjkghjk', 347, NULL, 'ghjkghjkghjk', 1, 123, 1, '2018-04-27', 4, 'AC'),
(11, 'L', '02-43876747-5', '2018-04-27 00:00:00', 'H-444', 'industrias srl', '237486', 'calle mi calle', 1, NULL, 'jdsjhjkdfhb', 1, 1, 0, '2018-04-27', 1, 'AC');
...
ALTER TABLE `tbl_denuncias`
  ADD CONSTRAINT `tbl_denuncias_ibfk_1` FOREIGN KEY (`inspectorid`) REFERENCES `tbl_inspectores` (`inspectorid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_denuncias_ibfk_2` FOREIGN KEY (`estableid`) REFERENCES `tbl_establecimiento` (`estableid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tbl_establecimiento`
  ADD CONSTRAINT `tbl_establecimiento_ibfk_1` FOREIGN KEY (`empleaid`) REFERENCES `tbl_establecimiento` (`estableid`) ON DELETE CASCADE ON UPDATE CASCADE;
