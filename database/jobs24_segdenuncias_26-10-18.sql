...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2018 a las 17:49:08
...
--
ALTER TABLE `tbl_denuncias_temp`
  MODIFY `denunciaid_temp` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbl_inspecciones`
  MODIFY `inspeccionid` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `trg_inspecciondenuncia`
  MODIFY `insden_id` int(11) NOT NULL AUTO_INCREMENT;
--
