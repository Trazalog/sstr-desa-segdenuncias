      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Actividad</a></li>
              <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Libros</a></li>
            </ul>
        ...
        <div class="box-footer">
          <button type="button" class="btn btn-primary pull-right" onclick="guardar()">Guardar</button>
        	<button type="button" class="btn btn-default pull-right" onclick="borrar()">Borrar</button>
        </div><!-- box-footer -->
      </div><!-- /.box -->
    </div><!-- /.col -->
  </div><!-- /.row -->
