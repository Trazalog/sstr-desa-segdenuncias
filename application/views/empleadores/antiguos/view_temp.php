          ...
          <div class="row">
            <div class="col-xs-12 col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nro-inscripcion" value="<?php echo $list['empleador']['empleainscrip'];?>">
              </div>
            </div>
            <div class="col-xs-12 col-md-4">
              <div class="form-group">
                <label for="expediente">Expediente</label>
                <input type="text" class="form-control" id="expediente" value="<?php echo $list['empleador']['empleaexp'];?>">
              </div>
            </div>
            <div class="col-xs-12 col-md-4">
              <div class="form-group">
                <label for="cuit">CUIT</label>
                <input type="text" class="form-control" id="cuit" value="<?php echo $list['empleador']['empleacui'];?>">
              </div>
            </div>
          </div><!-- /.row -->
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control input-sm" id="razon-social" value="<?php echo $list['empleador']['emplearazsoc'];?>">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="domicilio-real" value="<?php echo $list['empleador']['empleadomicilior'];?>">
              </div>
            </div>
          </div><!-- /.row -->
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="domicilio-legal" value="<?php echo $list['empleador']['empleadomiciliolegal'];?>">
              </div>
            </div>
          </div><!-- /.row -->
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="personal-masculino" value="<?php echo $list['empleador']['empleapmasc'];?>">
              </div>
            </div>
            <div class="col-xs-12 col-md-6">
              <div class="form-group">
                <label for="personal-femenino">Personal Femenino</label>
                <input type="text" class="form-control" id="personal-femenino" value="<?php echo $list['empleador']['empleapfem'];?>">
              </div>
            </div>
          </div><!-- /.row -->
        </div>
