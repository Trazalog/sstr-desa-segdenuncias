...
$(".sidebar .sidebar-menu a").click(function(event) {
    ...
    if( (typeof controller === "undefined") || (controller == '') ) {
        ...
        console.log( "controlador no definido => no hace nada"); //comentar esta línea en producción
    } else {
    ...
    console.log( "controlador: "+controller); //comentar esta línea en producción
    console.log( "metodo: "+action); //comentar esta línea en producción
    console.log( "permisos: "+permission ); //comentar esta línea en producción
});
