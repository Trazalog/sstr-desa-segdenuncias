            ...
            if( $user_image != '' ) {
                ...
                <div class="fileinput fileinput-exists" data-provides="fileinput" data-name="myimage">
                    ...
                    <div class="fileinput-new thumbnail" style="width: 150px; height: 150px; line-height: 20px;">
                        <img src="<?php echo base_url() .'assets/img/customers/avatar.png' ?>" />
                    </div>
                    <div class="fileinput-preview fileupload-exists thumbnail" style="max-width: 150px; max-height: 150px; line-height: 20px;">
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput" data-name="profileImage">
                    ...
                    <div>
                        ...
                        <span class="btn btn-default btn-file">
                            <span class="fileinput-new">Seleccionar imagen</span>
                            <span class="fileinput-exists">Cambiar</span>
                            <input type="file" id="input-img" name="myimage">
                        </span>
