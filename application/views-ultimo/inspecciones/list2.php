...
// FUNCIONES NUEVAS HUGO
  ...
  $(".btnView").on("click", function(e){
    ...
    $.ajax({
      ...
      success: function(data){             
              $('#tblDenEstabVer tbody tr').remove();
              var trow = ""; 
  ...
  function guardarInspeccion(){
    var inspeccionfechaasigna=$('#fechaAgreg').val();
    var inspeccionfecharecp=$('#fechaAgreg').val();
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="row"> 
      ...
      <div class="col-xs-9">  
        <table id="tblDenEstabVer" class="table table-bordered table-hover">
          <thead>
            <tr>                
              <th>Nro Acta</th>
              <th>Fecha</th>               
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="cuerpoModalEditar">
        ...
        <br>
        <div class="col-xs-6">
          <input type="text" class="form-control" id="fechaAgreg" name="fechaAgreg" value="<?php echo date_format(date_create(date("Y-m-d H:i:s")), 'd-m-Y H:i:s') ; ?>"  disabled/>
        </div><br><br>
